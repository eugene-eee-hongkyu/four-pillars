...
- **결정 1 (B)**: 친구·또래·학원 → Part 2 / 부모-자녀 합 분리 (§8 엄마·§9 아빠) / 사춘기 → §13 흐름 통합 ✓
- **결정 2 (B)**: 아빠 사주 미입력 시 §9 placeholder ("아빠 사주를 입력하시면 ...") — prompt에 명시 ✓
...
- 강요 금지(§10)·건강(§7)·엄마합(§8)·아빠합(§9) 어머니 톤 자연성 (Mom test)
