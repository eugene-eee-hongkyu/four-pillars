...
3. eduluck/docs/plan/A-2_v2.md      ← 11화면 풀 스펙
4. eduluck/docs/plan/A-3a_v1.md     ← Warm Heritage 디자인 컨셉 결정
5. eduluck/docs/plan/A-3b_v1.md     ← P0 checklist + 보강 사항
6. eduluck/docs/design/DESIGN_v1.1.md ← 확정 디자인 시스템
7. eduluck/docs/build/B-1_v2.md      ← 이 빌드 지침서 (유일한 실행 지침, Vercel·Supabase 채택)
