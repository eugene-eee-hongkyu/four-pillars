 ...
 *  direction-system.ts 의 10 카테고리 weight 에 흡수됨. UI는 이 4개만 노출. */
...
/** 10개 항목 어머니 친화적 설명 (UI 모달용) — 본질 한 줄 + 잘 맞는 트랙 */
export const TRAIT_DESCRIPTIONS: Record<keyof StudentTraits, { what: string; fits: string }> = {
  studyMind: {
    what: '조용히 깊이 파는 공부 스타일이에요. 책상에 오래 앉아 한 분야를 깊게 이해하는 본질이에요.',
    fits: '박사·연구원·의사·교사·자격증 직업',
  },
  examPower: {
    what: '평소 실력보다 시험장에서 더 잘 보는 본질이에요. 긴장해도 흔들리지 않고 정해진 시간 안에 답을 끌어내는 자리예요.',
    fits: '수능·자격증·면접·경시 같은 실전',
  },
  persistence: {
    what: '한 번 시작하면 끝까지 가는 본질이에요. 며칠에 폭발하는 스타일은 아니지만 1년·3년 길게 쌓이는 공부에서 결실이 나와요.',
    fits: '의대·고시·전문 자격증 (장기 누적형)',
  },
  comprehension: {
    what: '이해하고 응용하는 머리예요. 외우기보다 "왜 그런가" 생각하는 본질이에요.',
    fits: '수학·과학·논리·철학·코딩',
  },
  expression: {
    what: '말과 글로 자기 생각을 잘 전달하는 본질이에요. 발표·토론·작문에서 강한 자리예요.',
    fits: '언론·교육·상담·방송·작가',
  },
  selfDriven: {
    what: '스스로 결정하고 혼자 공부하는 본질이에요. 누가 떠밀어서 하는 것보다 자기가 선택한 길을 더 잘 가요.',
    fits: '인강·독학·프로젝트 학습 (학원 의존 ↓)',
  },
  competitiveness: {
    what: '1등 욕심·도전 본질이에요. 친구가 뭘 하면 자기도 한다 하는 자리예요. 점수가 약하면 자기 페이스가 더 잘 맞아요.',
    fits: '영재반·경시·랭킹 시험',
  },
  resilience: {
    what: '스트레스·실패에서 빠르게 회복하는 본질이에요. 한 번 흔들려도 다시 잡는 자리예요.',
    fits: '입시·재수·고시 같은 긴 압박 견디기',
  },
  arts: {
    what: '시각·창작·미디어 본질이에요. 색·이미지·소리를 잘 느끼고 만드는 자리예요.',
    fits: '디자인·미술·음악·영상·방송·미디어',
  },
  athletics: {
    what: '몸을 잘 쓰는 본질이에요. 체력·기세·외부 활동에서 강한 자리예요.',
    fits: '운동선수·체육·군경·외과 (몸+의지)',
  },
};
