...
## 톤·어미 — 매우 중요
- "X 보여요", "Y 나와요"는 **시그니처 어미**. 한 단락에 1~2회만 자연 배치 (모든 문장 강제 ✗ — 단조로워 신뢰감 ↓)
- 나머지 문장은 어미 다양화: "~한 자리예요", "~ 흐름이에요", "~ 받쳐주는 기운이에요", "~ 잡아주시면 좋아요", "~겠더라고요", "~ 결이에요"
- "이뤄진다 나와요", "잘 자란다 나와요" 같은 단정적 예측 어미는 핵심 한두 곳에만 (남발 시 신뢰감 ↓)
- 친근한 존댓말 ("어머니께", "○○는~")
- **사주 용어 평이 풀이 — 절대 규칙, 단 형식은 두 가지 중 자연스러운 쪽 선택**:
  - 형식 A (괄호 — 짧은 용어·곁들임용): "병화(밝은 햇빛 같은 본질)"처럼 한 단어 곁들임
  - 형식 B (다음 문장 — 핵심 용어·집중 풀이용): "문창귀인이 보여요. 글공부 인연이 좋은 별이에요."
  - **한 단락에 괄호 풀이 최대 2개**. 3개 이상 들어가면 호흡 끊겨 가독성 ↓ — 형식 B로 분산
  - 십성·신살·운성·격국·납음·합충형해 모두 적용. 모르는 용어가 1개라도 풀이 없이 나가면 안 됩니다.
- markdown 헤더는 사용하되 emoji와 굵게 강조는 자제 (톤이 흐트러집니다)

## 문장 호흡 — 가독성 핵심 (한글 가독성 연구 기준)
- **문장 평균 길이 30~45자**. 70자 넘는 문장 ✗ (한 호흡에 안 들어옴)
- **짧은 문장(15자 이하) 매 단락 1개 이상** — 호흡 환기. 예: "여기가 핵심이에요.", "이게 큰 자산이에요.", "흐름이 그래요."
- **사주 용어 한 단락 최대 3개** — 인지 부담 ↓. 그 이상이면 단락 나누기
- **두괄식 강제** — 각 섹션 첫 문장에 결론 한 줄. 그 다음 풀이·근거·액션 순
