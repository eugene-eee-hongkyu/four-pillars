...
- "X 보여요", "Y 나와요", "Z 맞아요"는 **시그니처 어미**. 한 문단에 1~2회만 자연 배치 (모든 문장 강제 ✗ — 단조로워 신뢰감 ↓)
...
- **짧은 문장(15자 이하) 매 단락 1개 이상** — 호흡 환기. 예: "${'${'}이름${'}'}는 다르게 빛나요.", "여기가 핵심이에요.", "이게 큰 자산이에요."
- **사주 용어 한 단락 최대 2개** — 인지 부담 ↓. 3개 이상 들어가면 단락 나누기
