...
- **사용자 본문에는 "1티어 / 2티어 / ..." 만 노출**. sub-tier 표기 (예: '1-2', '4-3') 는 본문 노출 절대 ✗.
- "엄청 강·강·약강" 같은 sub-tier 라벨도 본문 노출 ✗ (내부 분기용 only).
- sub-tier 의 첫 숫자만 본문 사용 (예: 4-2 → "4티어"). range 표시는 "○티어 안정 / ○티어 가능·(○+1)티어 안정 / ○티어 도전·(○+1)티어 안정".
