      ...
      <ScrollView contentContainerClassName="pt-12 pb-12 gap-4">
        ...
        <View className="px-container-padding gap-3">
          ...
          <Section title="제6조 (유료 콘텐츠 및 결제)">
            ...
            {'3. 리포트를 내려받은 시점부터 청약철회가 제한되며, 내려받기 전에는 결제일로부터 7일 이내 청약철회할 수 있습니다. 회사는 결제 화면에서 이에 대한 동의를 받습니다 (자세한 사항은 환불 정책 참조).\n'}
            {'4. 유료 PDF 리포트는 결제 완료 후 이용자가 입력한 이메일로 다운로드 링크 형태로 제공되며, 이용기간은 결제일로부터 1년입니다. 이용자는 이 기간 내에 링크를 통해 리포트를 다운로드할 수 있습니다.\n'}
            {'5. 이용기간(1년)이 경과하면 다운로드 링크는 만료되어 더 이상 다운로드할 수 없으며, 회사는 만료된 콘텐츠를 보관·재제공할 의무를 지지 않습니다. 이용자는 이용기간 내에 파일을 내려받아 보관하시기 바랍니다.\n'}
            {'6. 이용기간 만료로 인한 다운로드 불가는 환불 사유에 해당하지 않습니다.'}
          </Section>
