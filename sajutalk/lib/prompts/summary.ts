...
import { getInterpretSystem, type ToneType } from './interpret';
...
export function getSummarySystem(tone?: ToneType): string {
  return `${getInterpretSystem(tone)}${SUMMARY_SUFFIX}`;
}
